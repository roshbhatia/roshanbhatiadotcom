...
I ended up using [KeyboardToolsXYZ](https://keyboard-tools.xyz/) to generate (unwired) Kicad project. For the more dev inclined, Kicad has a Python based scripting engine that can be used for automating placements of "footprints" (think reusable components: diodes, the microcontroller, or your key switches) but it's something I encountered issues with. Rather than needing to script anything yourself, the KeyboardToolsXYZ just takes your KLE JSON and automates placing these footprints in a blank file for you. 
...
![](Keyboard%20designing%20for%20fools,%20by%20an%20idiot/pcb_traces.png)

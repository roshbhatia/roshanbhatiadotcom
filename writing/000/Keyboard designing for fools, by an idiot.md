...
Then I moved to wiring. This isn't particularly interesting, you just draw rows and columns and choose pins on the microcontroller to assign them to. I changed this a bit as I worked for some of the more uniquely placed keys but ultimately this stayed the same and didn't change too much. You can use tools like [https://kbfirmware.com/](https://kbfirmware.com/) if you have fewer keys to autogenerate firmware and wiring for you, but it's useful to just plug in some KLE json to see what I mean.
